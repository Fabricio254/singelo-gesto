"""Coleta e preparacao de produtos publicados no Instagram."""
...
def parse_brl(value: str) -> float: return float(value.replace(".", "").replace(",", "."))
...
def media_to_product(media: Any, username: str) -> Dict[str, Any]:
